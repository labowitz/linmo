...
```
conda create -n lineage_motif
source activate lineage_motif
```

## Installation

Installation with PyPI using pip is not currently supported. To install the `lineage_motif` package directly from GitHub, enter the following in terminal.

```
python -m pip install -e 'https://github.com/tranmartin45/lineage_motif.git'
```
