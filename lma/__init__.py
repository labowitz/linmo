...
- 'resample': Resamples tree dataset and exports count of doublet, triplet, or quartet across all resamples, the original trees,
    and the expected number (solved analytically).
